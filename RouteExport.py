...
def writeNode():
    with open(os.path.dirname(bpy.data.filepath) + '\\point.csv', 'w',encoding='shift_jis', newline='') as file:
        mywriter = csv.writer(file, delimiter=',')
        mywriter.writerows(numpy.array(generateNode()))
    
def writeRoute():
    with open(os.path.dirname(bpy.data.filepath) + '\\route.csv', 'w',encoding='shift_jis', newline='') as file:
